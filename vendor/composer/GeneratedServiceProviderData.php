    ...
    public static function providers(string $service): array {
        return match ($service) {
            ...
            \OpenTelemetry\API\Configuration\ConfigEnv\EnvComponentLoader::class => [
                \OpenTelemetry\API\Instrumentation\Configuration\General\ConfigEnv\EnvComponentLoaderHttpConfig::class, // open-telemetry/sdk 1.10.0 (extra.spi)
                \OpenTelemetry\API\Instrumentation\Configuration\General\ConfigEnv\EnvComponentLoaderPeerConfig::class, // open-telemetry/sdk 1.10.0 (extra.spi)
            ],
